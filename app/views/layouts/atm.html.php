...
<body  style="background-image:url(/img/worldmap.png);background-position:top;background-repeat:no-repeat; background-color:#F5FAEF " >
	<div id="container" class="container-fluid">
		<?php 
		extract(lithium\g11n\Message::aliases());
		$user = Session::read('member'); ?>
			<div class="row">
				<div class="span5"><img src="/img/ibwt.co.uk.gif" alt="ibwt.co.uk" style="margin-top:10px;margin-left:100px"></div>
				<div class="span5 pull-right" ><h2>BTC / LTC / GBP</h2></div>
			</div>
