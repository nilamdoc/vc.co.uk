...
function xTransferAmount(){
	amount = $("#Amount").val();
	$("#AmountToSendLTC").html(amount);
	$("#AmountToSend").show();
	$("#AmountToSendLTC").show();		
	$("#AmountButton").hide();
}
</script>
<div class="span10">
<h1>Withdraw</h1>
<h2><?=$t('Litecoin balance')?>: <?=number_format($details['balance.LTC'],8)?> LTC</h2>
<h2>Scan Your Litecoin Address</h2>
										<form action="/ATM/paymentltcverify/" method="post">
...
<br>
<p style="font-size:30px;display:none;font-weight:bold " id="AmountToSend" >Amount: <span id="AmountToSendLTC"></span></p>
<br>
			<a href="#myAmountModal"  id="AmountButton"  data-toggle="modal" class="btn btn-large btn-primary">Amount</a>
											...
											<h3>Scan Litecoin Address QR code </h3>
											</div>
											<div class="modal-body" style="text-align:center ">
												<input type="text" name="litecoinaddress" id="litecoinaddress" placeholder="L5AXfnf7hshkwgzA8UKvSyjpQdtz34H9LE" class="input-large" style="font-size:24px;height:46px;width:450px;padding:5px" title="To Address" data-content="This is the Litecoin Address of the recipient." value="" onblur="litecoinaddress();" />
											<div id="litecoinaddressWindow" style="display:none;border:1px solid gray;padding:2px;width:404px;margin:auto ">
