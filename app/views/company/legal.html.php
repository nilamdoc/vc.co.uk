...
<p><u><?=$t("Money Service Business (MSB), HMRC / Electronic Money Institute (EMI), FCA (formerly FSA)")?></u></p>
<p><?=$t("The current state of the UK governments view towards Bitcoin is a 'wait and see' approach, thankfully allowing Bitcoin time to grow and mature.")?></p>
<p><?=$t("IBWT is a legally abiding entity and as such will register with regulatory bodies as required by law if the situation changes.")?></p>
<p><a href="/news"><?=$t("More information can be found with our News Release")?></a>.</p>

<p><?=$t("If you feel we have not satisfactorily dealt with any issue you have with regards to our privacy policy and your personal data, you can contact the Information Commissioners Office.")?></p>
