...
<p><a href="https://ibwt.co.uk/">https://ibwt.co.uk/</a> is a site operated by of IBWT JD LTD ("<strong>IBWT</strong>"), a company incorporated under the laws of England and Wales. Registered address: 31 North Down Crescent, Keyham, Plymouth, Devon, United Kingdom, company number: 08854667. Our VAT number is 165221136. IBWT is regulated by the Information Commissioners Office, registered no: ZA007784.</p>
<p>These Terms of Service ("<strong>Terms</strong>") set the conditions by which a customer, as a registered user ("<strong>Customer(s)</strong>") can use our services for the purposes of becoming buyers ("<strong>Buyers</strong>") and sellers ("<strong>Sellers</strong>"), transferring the digital value asset known as "Bitcoin(s)"</p>
<p>The services allow Customers to transfer funds into ("Deposit") or from ("Withdrawal") their IBWT account to their registered linked bank account. And to interact with other businesses or individuals who accept bitcoin.</p>
<p>The services that this site gives is only currently available to United Kingdom residents.</p>

<p>By submitting a request to open an account ("Account") customers confirm that they;
<ul>
<li>are at least 18 years of age and have the full capacity to wilfully accept these Terms of Service and enter into a transaction resulting on the Platform. </li>
<li>have submitted a true representation of documents to verify their identity. </li>
<li>are resident within the United Kingdom. </li>
<li>and have accepted these Terms of Service.</li>
</ul>
</p>
<p>IBWT reserves the right to amend, change, add or remove sections of these Terms at any time. Customers will be notified via a News Release on the IBWT site. It is Customers responsibility to review any such amendments.</p>
...
<p>IBWT grants its Customers non-exclusive, personal, non-transferable, non-sub licensable and limited right to enter and use the IBWT site and services.</p>

<h4>DEFINITIONS</h4>

<p><strong>Platform</strong>: means the software, technical and organisational structure managed by IBWT located at the https://ibwt.co.uk/address.</p>
...
<p><strong>Buyer(s)</strong>: means Customers(s) that submit an offer to buy Bitcoin(s) on the Platform.</p>
...
<ul>
	...
	<li>The transfer of Bitcoins among Customers ("Bitcoin Transfer Transaction"), </li>
...
<li>That values of Bitcoin (or alt coins) are determined by Customers initiating Buy or Sell orders.</li>
...
<li>Customers acknowledge that IBWT is regulated to the current standards with regards to the laws in England and Wales and as required by HM Treasury, HMRC and FCA (formerly FSA), and accept that IBWT requires whatever time necessary to adhere to any new regulations and laws.</li>
</ul>
</p>
</li>
...
<p>Without IBWT express prior consent, other websites may only link to the Platform by using the following address: https://ibwt.co.uk/ to the exclusion of any deep link.</p>
</li>
...
<p>By using our website, you understand and agree that all Resources IBWT provides are "as is" and "as available". This means that IBWT do not represent or warrant to you that:
<ol>
...
<li>any defects in the operation or functionality of any Resources IBWT provides will be repaired or corrected.</li>
<br>
...
<li>no information or advice, whether expressed, implied, oral or written, obtained by you from IBWT JD Ltd or through any Resources IBWT provides shall create any warranty, guarantee, or conditions of any kind, except for those expressly outlined in this User Agreement.</li>
</ol>
</p>
...
<p>Customers will be held solely liable for losses incurred by IBWT or any other user of the Site due to someone else using their password or user account.</p>
<p>Customers affirm and warrant that they are the legitimate owners of represented funds of any denomination used in relation to the Platform and the Services provided by IBWT.</p>
...
<p>IBWT may attempt to refund a customers account balance of GBP to the registered bank account dependent upon the issue at hand, and  a customer  will have 60 days within receiving such notice to notify IBWT via support@ibwt.co.uk of a bitcoin withdrawal address if  a customer  had bitcoins held on his/her account. Again under the assumption that such termination was not because of any fraud, criminal 8activity, or any other related matter.</p>
...
<p>Customers agree and acknowledge that IBWT can suspend their Account at will until the relevant Customer provides IBWT with documents evidencing their identity and/or any other information IBWT deems as necessary to secure the Account, Transactions, Platform, or services IBWT provides.</p>
...
<p>Customers acknowledge that suspension or termination of an Account can affect any business account they have with IBWT in a similar manner and will affect future applications to become a Customer of IBWT.</p>
<p>IBWT reserve the right to refuse an Account and relevant services to any applicant or current Customer for, but not limited to, suspected fraud, criminal activity or abusive behaviour.</p>
