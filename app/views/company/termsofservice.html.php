...
<p><strong><?=$t("Bitcoin(s)")?></strong>: <?=$t("means the Peer-to-Peer digital transfer value asset (as described at ")?><a href="http://bitcoin.org/en/">http://bitcoin.org/en/</a>).</p>

<p><strong><?=$t("Seller(s)")?></strong>: <?=$t("means Customers(s) that submit an offer to sell Bitcoin(s) on the Platform.")?></p>
...
<ul>
	<li><?=$t("The agreement between the Buyer and the Seller to exchange Bitcoins on the Platform for currencies at a commonly agreed rate ('Bitcoin Purchase Transaction'),")?> </li>
	<li><?=$t("The conversion of currencies deposited by Customers on their account ('Conversion Transaction'),")?> </li>
	<li><?=$t("The transfer of Bitcoins among Customers ('Bitcoin Transfer Transaction'),")?> </li>
...
<p><?=$t("Customers may use the Platform to place orders to buy or sell Bitcoin, or they may buy or sell Bitcoin(s) at the current value that is offered by other Customers.")?></p>
...
<p><?=$t("The matching of offers and transfer of funds is a service provided by IBWT via the Platform. Under the Distance Selling Directive 97/7/EC, once Buyers and Sellers offers have been matched, Customers forfeit the ability to cancel any Bitcoin Transaction.")?></p>
<p><?=$t("Customers accept that transferring bitcoins to their IBWT account or to other addresses is reliant upon the protocol and any 'miner' fee they choose to pay and that IBWT has no influence in this. The average time for Bitcoin transference can be 10 minutes to 24 hours, barring unforeseen or unavoidable network issues.")?></p>
...
<p><?=$t("Customers may at any time transfer any amount of Bitcoins to any other Customer as well as any other Bitcoin users even if they are not Customers (the 'Receiver').")?></p>
<p><?=$t("Customers can not transfer GBP.")?></p>
<p><?=$t("Customers are solely responsible for ensuring that any Receiver of their Bitcoins shall be a valid and legal transaction not infringing any UK or International laws and regulations.")?></p>
...
<p><?=$t("No Commission of any kind will be charged by IBWT for Bitcoin being moved as Bitcoin, in, out, or around the Platform, a Bitcoin Transfer Transaction.")?></p>
</li>
...
<li><?=$t("That values of Bitcoin (or alt coins) are determined by Customers initiating Buy or Sell orders.")?></li>
...
<li><?=$t("Customers acknowledge that buying and selling of Bitcoin is done via Customer with Customer and IBWT only acts as an intermediary to facilitate such transactions, not as a counterparty. That it is the Customers responsibility to comply with all laws and regulations relating to the transactions.")?></li>
<li><?=$t("Customers are solely responsible for their accounts activities which include, but are not limited to, Deposits, Withdrawals, transferring Bitcoins.")?></li>
<li><?=$t("Buyers and Sellers warrant to each other that the money type in either denomination is true to their value representation. Corresponding to either fiat or bitcoin.")?></li>
...
<p><?=$t("Customers may print off one copy, and may download extracts, of any page(s) from our site for Customers personal reference and Customers may draw the attention of others within their organisation to material posted on our site.  ")?></p>
...
<p><?=$t("IBWT 'In Bitcoin We Trust.' Is a registered trade mark of IBWT JD LTD, and is protected by patent, trademark and copyright under English and international laws and may not be used without IBWT express written consent.")?></p>
...
<p><?=$t("IBWT may attempt to refund a customers account balance of GBP to the registered bank account dependent upon the issue at hand, and  a customer  will have 60 days within receiving such notice to notify IBWT via ")?><a href="mailto:support@<?=COMPANY_URL?>">support@<?=COMPANY_URL?></a><?=$t(" of a bitcoin withdrawal address if  a customer  had bitcoins held on his/her account. Again under the assumption that such termination was not because of any fraud, criminal 8activity, or any other related matter.")?></p>
