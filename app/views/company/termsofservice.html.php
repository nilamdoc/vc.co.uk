...
<p>Customers agree that all Accounts are personal Accounts, in that linked bank accounts must be in their name. And that no business Account will be opened unless requested via email to <a href="mailto:support@<?=COMPANY_URL?>">support@<?=COMPANY_URL?></a>. </p>
