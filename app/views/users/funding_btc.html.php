			...
			<div class="accordion-inner">
				<div class="row">
					<div class="span5">
						<div class="navbar">
							...
							<p>You can also deposit BTC without login to the site, bookmark this URL<br>
							<a href="https://ibwt.co.uk/deposit/btc/<?=$user['email']?>" target="_blank">https://ibwt.co.uk/deposit/btc/<?=$user['email']?></a>
							</p>
						</div>
					</div>
					<div class="span5">
				...
				<input type="text" name="bitcoinaddress" id="bitcoinaddress" placeholder="15AXfnf7hshkwgzA8UKvSyjpQdtz34H9LE" class="span4" title="To Address" data-content="This is the Bitcoin Address of the recipient." value="" onblur="BitCoinAddress();"/>
							...
							<table class="table table-condensed table-bordered table-hover" style="margin-top:-20px">
								...
								<tr>
									<td>
										<a href="/Users/removetransaction/<?=String::hash($transactions['_id'])?>/<?=$transactions['_id']?>/funding_btc"><i class="icon-remove"></i> <?=number_format($transactions['Amount'],8)?> LTC</a>
									</td>
								</tr>
							</table>
							<?php }?>
